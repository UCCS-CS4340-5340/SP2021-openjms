...
public class TestSelectorTreeParser {
  ...
  public void test3()  throws Throwable  {
      SelectorTreeParser selectorTreeParser0 = new SelectorTreeParser();
      try {
        selectorTreeParser0.expression((AST) null);
  ...
  public void test9()  throws Throwable  {
      SelectorTreeParser selectorTreeParser0 = new SelectorTreeParser();
      AST aST0 = selectorTreeParser0.getAST();
      try {
        selectorTreeParser0.isExpression(aST0);
  ...
  public void test11()  throws Throwable  {
      SelectorTreeParser selectorTreeParser0 = new SelectorTreeParser();
      try {
        selectorTreeParser0.betweenExpression((AST) null);
        fail("Expecting exception: MismatchedTokenException");
      } catch(MismatchedTokenException e) {
        /*
         * expecting \"between\", found '<empty tree>'
         */
      }
  }
  ...
  public void test15()  throws Throwable  {
      SelectorTreeParser selectorTreeParser0 = new SelectorTreeParser();
      try {
        selectorTreeParser0.inExpression((AST) null);
        fail("Expecting exception: MismatchedTokenException");
      } catch(MismatchedTokenException e) {
        /*
         * expecting \"in\", found '<empty tree>'
         */
      }
  }
  ...
  public void test17()  throws Throwable  {
      SelectorTreeParser selectorTreeParser0 = new SelectorTreeParser();
      try {
        selectorTreeParser0.valueList((AST) null);
        fail("Expecting exception: MismatchedTokenException");
      } catch(MismatchedTokenException e) {
        /*
         * expecting a string literal, found '<empty tree>'
         */
      }
  }

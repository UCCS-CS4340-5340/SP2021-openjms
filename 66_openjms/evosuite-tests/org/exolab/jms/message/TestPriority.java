...
public class TestPriority {
  ...
  public void test5()  throws Throwable  {
      Priority priority0 = new Priority(7);
      assertNotNull(priority0);
      
      boolean boolean0 = priority0.isExpedited();
      assertEquals(true, boolean0);
      assertEquals(7, priority0.getPriority());
  }
  ...
  public void test7()  throws Throwable  {
      Priority priority0 = new Priority();
      Priority priority1 = new Priority(7);
      assertNotNull(priority1);
      
      boolean boolean0 = priority1.isGreater(priority0);
      assertEquals(7, priority1.getPriority());
      assertEquals(0, priority0.getPriority());
      assertEquals(true, boolean0);
  }
